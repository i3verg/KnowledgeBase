...
function getFixedCols(renderConfig, layout) {
    var leftSplit = renderConfig.leftSplit, configSpans = renderConfig.spans, $totalWidth = renderConfig.$totalWidth, configColumns = renderConfig.columns, $totalHeight = renderConfig.$totalHeight, headerHeight = renderConfig.headerHeight, configFooterHeight = renderConfig.footerHeight, $positions = renderConfig.$positions, $renderFrom = renderConfig.$renderFrom, scroll = renderConfig.scroll, data = renderConfig.data;
    ...
    var filteredSpans = configSpans === null || configSpans === void 0 ? void 0 : configSpans.filter(function (span) {
        ...
        return colIndex > -1 && colIndex <= leftSplit;
    });
...
function getFixedDataRows(config, layout) {
    ...
    var filteredSpans = configSpans === null || configSpans === void 0 ? void 0 : configSpans.filter(function (span) {
        ...
        var colIndex = columns.findIndex(function (c) { return c.id == span.column; });
        var leftSplited = colIndex > -1 && colIndex <= leftSplit;
